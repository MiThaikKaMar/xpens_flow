...
class _TransactionAddPageState extends State<TransactionAddPage> {
  ...
  double _getEditedAmount() {
    final text = _amountEditingController.text.trim();
  ...
  void _handleSaveTransaction(BuildContext context, Transaction transaction) {
...
${transaction.splits}, ${transaction.createdAt}, ${transaction.updatedAt}
  ...
  Widget build(BuildContext context) {
    return BlocListener<TransactionEditorBloc, TransactionEditorState>(
      listener: (context, state) {
        if (state is TransactionSubmitted) {
          showSnackbar(context, "Transaction saved successfully");
          widget._transactionFeedBloc.add(TransactionFeedShowAll());
          context.pop();
        }

        if (state is TransactionSubmissionError) {
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text("Suggested"),
                    Row(
                      children: ["Starbucks ", "KFC ", "McDonald’s ", "Uber"]
                          .map((merchant) {
          ...
          builder: (context) {
            return ElevatedButton(
              onPressed: () {
                ...
                _handleSaveTransaction(context, newTransaction());
              },
